...
type Branch struct {
	...
	BranchCode       string       `json:"branch_code" gorm:"type:varchar(100);uniqueIndex;not null"`
	ParentBranchCode string       `json:"parent_branch_code" gorm:"type:varchar(100)"`
...
type CreateBranchRequest struct {
	...
	ParentBranchCode string   `json:"parent_branch_code"`
